        ...
        <div class="container">
        	...
        	<div class="gall_text_container">
      		...
      		<div class="product_container">
                ...
                $exe_gallery = mysql_query($sql_gallery) or die(mysql_error());
                $num_gallery = mysql_num_rows($exe_gallery);
                if($num_gallery>0)
                {
                    while($arr_gallery = mysql_fetch_array($exe_gallery))
                    {
                        ?>
				...
				?>
      			...
      			<div class="partner_container">
                    ...
                    $exe_partners = mysql_query($sql_partners) or die(mysql_error());
                    $num_partners = mysql_num_rows($exe_partners);
                    if($num_partners>0)
                    {
                        while($arr_partners = mysql_fetch_array($exe_partners))
                        {
                            ?>
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 no-pad-left">
                                <div class="partner_area"><img src="<?php echo SITE_URL;?>uploads/partner/thumb/<?php echo stripslashes($arr_partners['partner_image']);?>" alt=""></div>
                            </div>
                            <?php
						}
					}
