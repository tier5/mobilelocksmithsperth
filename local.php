        ...
        <div class="container">
            <div class="row">
                <div class="services_section clearfix">
					...
					<?php
                    $fetch_left_content = mysql_fetch_array(mysql_query("SELECT * FROM `ml_contents` WHERE `content_id` = '2'"));
					...
					<?php
                    $fetch_right_content = mysql_fetch_array(mysql_query("SELECT * FROM `ml_contents` WHERE `content_id` = '3'"));
